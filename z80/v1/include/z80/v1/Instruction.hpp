...
__attribute__((always_inline)) std::uint8_t access_time(const Instruction::Operand rhs) {
  switch (rhs) {
...
__attribute__((always_inline)) std::uint8_t rmw_access_time(const Instruction::Operand lhs) {
  switch (lhs) {
    case Instruction::Operand::BC_Indirect8:
    case Instruction::Operand::DE_Indirect8:
...
__attribute__((always_inline)) std::uint8_t access_time(const Instruction::Operand lhs, const Instruction::Operand rhs) {
...
__attribute__((always_inline)) Instruction::Output alu8(
...
__attribute__((always_inline)) inline bool Instruction::should_execute(const Flags flags) const {
...
__attribute__((always_inline)) inline Instruction::Output Instruction::apply(const Input input, Z80 &cpu) const {
